...
class DashboardController extends AbstractDashboardController
{
    ...
    public function configureMenuItems(): iterable
    {
        ...
        //yield MenuItem::section('Ouvertures Exceptionnelles');
        yield MenuItem::subMenu('Ouvertures exceptionnelles', 'fas fa_bars')->setSubItems([
            MenuItem::linkToCrud('Ajouter', 'fas fa-plus', OuvertureExcept::class)->setAction(Crud::PAGE_NEW),
            MenuItem::linkToCrud('Modifier', 'fas fa-eye', OuvertureExcept::class)
        ]);
        yield MenuItem::section('_____________________________');
